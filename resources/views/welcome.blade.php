...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets/css/home.css')?>" type="text/css"> 
    ...
    <main class="">
        <header class="container mx-auto mt-6 px-4 flex justify-between items-center"><!-- Start Header -->
            ...
            <div class="flex items-center">
                <div class="hidden md:block space-x-6 font-medium">
                    @auth
                    <a href="{{ url('/dashboard') }}" class="bg-green-600 hover:bg-green-700 transition-colors duration-300 py-2.5 px-5 rounded-lg text-white font-semibold">Dashboard</a>
  
                @else
                   
                    <a href="{{ route('login') }}" class="bg-green-600 hover:bg-green-700 transition-colors duration-300 py-2.5 px-5 rounded-lg text-white font-semibold">Login</a>
                    @endif
                </div>
                <div class="md:hidden">
                    <a href="#0" class="">
        ...
        <section class="container mx-auto px-4 py-12 sm:py-16 md:py-20 xl:py-28"><!-- Start Hero -->
            <div class="grid lg:grid-cols-2 gap-10 items-center">
                <div class="space-y-8 lg:space-y-12">
                    <div class="space-y-6">
                        <h1 class="text-4xl sm:text-6xl font-semibold">Sistem Informasi <br>Cuci Mobil</h1>
                ...
                <div class="">
                    <img src="assets/img/hero.jpg" alt="Illustration">
                </div>
            </div>
        </section><!-- End Hero -->
        ...
        <section class="container mx-auto px-4 py-12 sm:py-16 md:py-20 xl:py-28"><!-- Start Testimonials -->
            ...
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-10">
                <div class="border-2 border-gray-200 rounded-lg p-8 transition-colors duration-200 hover:border-green-600">
        ...
        <section class="container mx-auto sm:px-4"><!-- Start Sing up -->
            <div class="bg-green-600 px-4 py-12 sm:py-16 md:py-20 xl:py-28 sm:rounded-lg text-white">
                ...
                <div class="flex flex-col sm:flex-row space-y-2.5 sm:space-y-0 justify-center">
                    <input class="w-full sm:w-72 border-solid border-2 sm:border-r-0 py-4 px-6 rounded-lg sm:rounded-none sm:rounded-tl-lg sm:rounded-bl-lg outline-none border-white focus:border-green-700" type="text" placeholder="Your email address">
                    <button type="submit" class="bg-green-700 hover:bg-green-800 transition-colors duration-300 py-4 px-6 rounded-lg sm:rounded-none sm:rounded-tr-lg sm:rounded-br-lg text-white font-semibold">Get Started</button>
                </div>
            </div>
        </section><!-- End Sing up -->
        ...
        <footer class="container mx-auto px-4 mt-6 py-6">
            ...
            <div class="flex flex-col md:flex-row md:justify-center space-y-2 md:space-y-0 md:space-x-3 text-gray-500 text-xs">
                <p>Copyright © 2022 Tugas Lea. All rights reserved.</p>
