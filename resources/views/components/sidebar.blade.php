...
$links = [
    ...
    [
        "href" => [
            [
                "section_text" => "Pemesanan",
                "section_list" => [
                    ["href" => "user", "text" => "Data Pemesanan"],
                ]
            ]
        ],
        "text" => "Pemesanan",
    ...
    [
        "href" => [
            [
                ...
                "section_list" => [
                    ["href" => "user", "text" => "Jenis Mobil"],
                    ["href" => "user.new", "text" => "Merek Mobil"],
                    ["href" => "user.new", "text" => "Layanan"],
                    ["href" => "user.new", "text" => "Paket"]
                ]
            ]
        ],
        "text" => "Data Master",
